...
onig_tarball_path = join(dependencies_dir_path, "onig-6.9.9.tar.gz")
onig_install_path = join(dependencies_dir_path, "onig_install")
onig_source_path = join(dependencies_dir_path, "onig-6.9.9")

jq_tarball_path = join(dependencies_dir_path, "jq-1.7.1.tar.gz")
jq_install_path = join(dependencies_dir_path, "jq_install")
jq_source_path = join(dependencies_dir_path, "jq-jq-1.7.1")
